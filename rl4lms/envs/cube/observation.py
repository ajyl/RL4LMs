...
class Observation:
    ...
    def update(self, action: int, tokenizer: CubeTokenizer) -> "Observation":
        """
...
if __name__ == "__main__":
    ...
    obs = Observation.init_from_sample(
        sample=sample, tokenizer=tokenizer, max_input_length=24, max_context_length=24
    )
